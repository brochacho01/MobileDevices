...
const DeleteButton = ({ index, removeComment}) => {

    const [modalVisible, setModalVisible] = useState(false);

    return (
        <View>
            {/* This is a button that when pressed will cause a modal to appear asking the user to confirm comment deletion */}
            ...
            <View>
                ...
                {/* This is the modal that appears when the delete button is pressed */}
                <Modal
                    testID={'modal'}
                    animationType="fade"
                    transparent={true}
                        ...
                        <View style={styles.modalTextArea}>
                            ...
                            <View style={styles.modalButtonArea}>
                                ...
                                <Pressable
                                    ...
                                    onPress={() => { removeComment(index), setModalVisible(false) }}>
